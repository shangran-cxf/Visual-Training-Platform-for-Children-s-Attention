...
PROMPT_TEMPLATES = {
    "current_training_evaluation": {
        ...
        "user_prompt_template": (
            ...
            "## 输出 JSON 格式（严格遵守字数限制）\n"
            "{{\n"
            '  "summary": "训练趋势总结（40-60字，聚焦趋势变化，简要）",\n'
            '  "strengths": ["优势1（15-50字）", "优势2（15-50字）"],\n'
            '  "weaknesses": ["待提升点1（15-50字）", "待提升点2（15-50字）"],\n'
            '  "suggestions": ["建议1（15-50字）", "建议2（15-50字）"],\n'
            '  "home_guidance": ["家庭指导1（20-50字）", "家庭指导2（20-50字）", "家庭指导3（20-50字）"],\n'
            '  "trend_analysis": [\n'
            ...
            "写作要求：\n"
            "1. 语言亲切自然，像和朋友交流一样\n"
            "2. strengths/weaknesses/suggestions 恰好2条，home_guidance 恰好3条\n"
            "3. 分析数据间关系而非罗列数字\n"
            "4. 建议具体可操作，家长容易执行"
        ),
    },
