...
class MedalUtil {
  ...
  static showUnlockNotification(medal) {
    ...
    const medalImage = medal.image || (defaultMedal ? defaultMedal.image : 'medal-image/game1.webp');
